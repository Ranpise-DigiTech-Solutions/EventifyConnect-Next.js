...
import styles from "./vendor-description.module.scss";
...
const HallDescriptionComponent = ({ vendorType, vendorData }: Props) => {
  const responsive = {
    desktop: {
    ...
    <>
      <div className={styles.hallDescription__container}>
        <div className={styles.slider__wrapper}>
          ...
          >
            {vendorData && vendorType === "HALL" ? (
              vendorData.hallImages &&
              vendorData.hallImages.map((image: string, index: number) => (
                <img src={image} key={index} alt="Img" />
              ))
            ) : (
              <img src={"/images/Hall_01.jpg"} alt="Img" />
            )}
          </Carousel>
        </div>
        {vendorType === "HALL" ? (
          <div className={styles.quickinfo}>
            <h2>{vendorData.hallName}</h2>
            <h3 className={styles.location}>
              <a href="https://www.google.com/maps/dir//TMA+Pai+Convention+Centre,+MG+Rd,+Kodailbail,+Mangaluru,+Karnataka+575003/@12.8803793,74.7986391,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3ba35a44b7805283:0xbb55b8b40db48da!2m2!1d74.8398387!2d12.8803825?entry=ttu">
                <FaMapMarkerAlt /> {vendorData.hallTaluk}, {vendorData.hallCity}
                , {vendorData.hallState}
              </a>
            </h3>
          ...
          <div className={styles.quickinfo}>
            <h2>Monark Digital Studio</h2>
            <h3 className={styles.location}>
              <a href="https://www.google.com/maps/dir//TMA+Pai+Convention+Centre,+MG+Rd,+Kodailbail,+Mangaluru,+Karnataka+575003/@12.8803793,74.7986391,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3ba35a44b7805283:0xbb55b8b40db48da!2m2!1d74.8398387!2d12.8803825?entry=ttu">
                <FaMapMarkerAlt /> Mysore, Kerala, India
              </a>
            </h3>
            <div className={styles["stars-container"]}>
              <ReactStars
